...
// const animals = {
//     fish: 'icon-clownfish_animal_pet_creature_animals_icon_182998',
//     dog: 'icon-pet-animal-pets-paw-dog-cat-paws_108559',
// };
...
document.body.addEventListener('click', function (e) {
    //if (e.target.classList.contains('plitka')) console.log(e.target); //e.target.style.backgroundColor = "red";
    if (e.target.classList.contains('plitka')) document.getElementById('catch').appendChild(e.target); //e.target.style.backgroundColor = "red"; catch
});
